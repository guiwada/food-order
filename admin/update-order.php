    ...
    <div class="wrapper">
        ...
        if (isset($_GET['id'])) {
            ...
            if ($count == 1) {
                ...
                // Redirecione para a página de gerenciamento de pedidos
        ...
        <form action="" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="customer_address" id="" cols="30" rows="5"><?php echo $customer_adress; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
